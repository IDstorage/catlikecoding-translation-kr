...
> 	<br><br>
> 	소수를 소수점 이후 3자리, 앞에 1자리로 표현하기로 했다고 가정해봅시다. $1\over 3$은 근사치인 0.333 입니다. 이를 100으로 나누면 두 자리 만큼의 정확도를 잃은 0.003이라고 써야 하죠. 이런 작은 값들의 정확도를 높이기 위해 수의 크기를 나타내는 별도의 지수를 추가합니다. 그럼 정확도를 잃지 않고 $0.333 \times 10^{-2}$ 처럼 표현할 수 있습니다. 100을 곱한 $0.333 \times 10^2$도 마찬가지로 정확도가 유지됩니다. 그래서 소수점은 위치가 고정되지 않고 부동으로 간주됩니다. 이는 몇 자리 숫자로도 큰 수를 표현할 수 있게 합니다.
> 	<br><br>
...
> 	<br>대부분의 게임은 그렇습니다. 소수점 오류에 굉장 민감한 프로그램이 아니면 문제를 일으키지 않습니다. 
> </details>
<br>
