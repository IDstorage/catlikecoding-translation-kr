...
윗면과 조금 다른 부분이 있습니다. 정점 인덱스도 다르고, 첫 행이 조금 더 복잡합니다. We also have to change the orientation of the quad vertices so they face down instead of up. I also made sure that the triangle diagonals point in the opposite direction of those from the top face, so this is the case for all opposite faces.
