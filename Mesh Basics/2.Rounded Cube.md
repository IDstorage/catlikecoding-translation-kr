...
그럼 이제 정점을 어떻게 배치할까요? 원래 큐브 속에 떠있는 작은 큐브를 상상해보세요. 두 큐브의 서로 대응되는 면 사이의 거리는 진원도와 같습니다. You could imagine spheres stuck on the corners of this smaller cube, their radius equal to the roundness, so the inner cube is firmly held in place.
